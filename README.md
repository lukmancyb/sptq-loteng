...
-   Setelah Di unduh silahkan ubah nama database anda pada file application > config > database.php
-   Atur juga base_url yang ada pada file application > config > config.php
