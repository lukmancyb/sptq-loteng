...
<head>
  ...
  <title><?= isset($title) ? $title : "Pengumuman List"; ?> - LPTQ Kabupaten Lombok Tengah</title>
            ...
            <div class="box-body">
              <table id="example1" class="table table-striped" style="font-size:13px;">
				...
				<?php foreach ($data->result_array() as $i) :
                    ...
                    ?>
                <tr>
                  <td><img width="40" height="40" class="img-circle" src="<?php echo base_url().'assets/images/pengguna/'.$pengguna_photo;?>"></td>
