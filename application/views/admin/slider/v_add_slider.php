...
<head>
    ...
    <title><?php echo isset($title) ? $title : "Tambah Slider";?></title>
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <form action="<?= base_url('admin/slider/simpan_slider');?>" method="post" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-8">
                        <div class="box box-danger">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <input type="text" name="title" class="form-control" placeholder="Judul Slider"
                                           required/>
                                </div>
                                <div class="form-group">
