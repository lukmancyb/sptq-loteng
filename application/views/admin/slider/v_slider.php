                        ...
                        <div class="box">
                            <div class="box-header">
                                <a class="btn btn-success btn-flat"
                                   href="<?= base_url('admin/slider/add_slider'); ?>"><span
                                            class="fa fa-plus"></span> Tambah Slider</a>
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
                                <table id="example1" class="table table-striped" style="font-size:13px;">
                                    ...
                                    <?php foreach ($sliders as $key => $value) : ?>
                                        <tr>
                                            <td><?= $key + 1; ?></td>
                                            <td>
                                                <img src="<?php echo base_url() . 'assets/images/slider/' . $value->img_url; ?>"
                                                     style="width:90px;"></td>
                                            ...
                                            <td style="text-align:right;">
                                                ...
                                                <a class="btn"
                                                   href="<?= base_url('admin/slider/edit_slider/' . $value->id); ?>"><span
            ...
            <div class="modal-content">
                ...
                <form class="form-horizontal" action="<?php echo base_url().'admin/slider/hapus_slider'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <input type="hidden" value="<?php echo $img_url;?>" name="gambar">
