...
<section>
    <!-- <div class="slider_img layout_two">
        <div id="carousel" class="carousel slide" data-ride="carousel">
            <ol class="carousel-indicators">
                ...
                <li data-target="#carousel" data-slide-to="<?="$key" ;?>" class="<?php echo ($key == 0) ? 'active' : ''; ?>"></li>
                <?php endforeach; ?>
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="carousel-item <?php echo ($key == 1) ? 'active' : ''; ?>">
                    <img class="d-block" src="<?php echo base_url() . 'assets/images/slider/' . $value->img_url ?>"
                        alt="First slide">
                </div>
                <?php endforeach; ?>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        <ol class="carousel-indicators">
            <?php foreach ($sliders as $key => $value): ?>
                <li data-target="#carouselExampleIndicators" data-slide-to="<?="$key";?>" class="<?php echo ($key == 0) ? 'active' : ''; ?>"></li>
            <?php endforeach; ?>
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item <?php echo ($key == 0) ? 'active' : ''; ?>">
                <img class="d-block w-100" src="<?php echo base_url() . 'assets/images/slider/' . $value->img_url ?>"
                    alt="First slide">
            </div>
            <?php endforeach; ?>
        ...
        <a class="carousel-control-prev" href="#carouselExampleIndicators" role="button" data-slide="prev">
            <span class="carousel-control-custom-icon" aria-hidden="true">
                <i class="icon-arrow-left fa-slider"></i>
            </span>
            <span class="sr-only">Previous</span>
        </a>
        <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next">
            <span class="carousel-control-custom-icon" aria-hidden="true">
                <i class="icon-arrow-right fa-slider"></i>
            </span>
            <span class="sr-only">Next</span>
        </a>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                ...
                <p>Kami Menyambut baik terbitnya Website <b> LPTQ Lombok Tengah </b> yang baru , dengan harapan
                    dipublikasinya
                    website ini, masyarakat bisa memperoleh informasi mengenai kegiatan yang diseleggarkan oleh LPTQ
                    Lombok Tengah
