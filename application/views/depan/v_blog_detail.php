...
<title><?= isset($title) ? $title : "Detail"; ?></title>
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="blog-img_block">
                        <img src="<?php echo base_url() . 'assets/images/berita/' . $image ?>" class="img-fluid"
                             alt="blog-img">
                        <div class="blog-date">
                    ...
                    <div class="blog-tiltle_block">
                        ...
                        <h6><a href="#"><i class="fa fa-user" aria-hidden="true"></i><span><?php echo $author; ?></span>
                            </a> | <a href="#"><i class="fa fa-tags"
                                                  aria-hidden="true"></i><span><?php echo $kategori; ?></span></a></h6>
                        <?php echo $blog; ?>
                    </div>
