<?php
    $menu=$this->db->query("SELECT menu, slug, id FROM tbl_page WHERE is_active='1'")->result();
    // var_dump($query);die;
?>
            ...
            <div class="row">
                <div class="col-xs-6 col-sm-8 col-md-9">
                    <div class="header-top_address">
                        ...
                        <div class="header-top_list">
                            <span class="icon-location-pin" style="color: #fff;"></span>Praya - Lombok Tengah, Nusa
                            Tenggara Barat, INA.
                        </div>
                    </div>
                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="dropdown">
                                    <a class="dropdown-item dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"
                                        aria-expanded="false" href="#">Profil</a>
                                    <ul class="dropdown-menu dropdown-menu2">
                                        <li><a class="dropdown-item" href="<?php echo site_url('about'); ?>">Tentang</a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="<?php echo site_url('prestasi'); ?>">Prestasi</a></li>
                                        <li>
                                            <a class="dropdown-item" href="<?php echo site_url('galeri'); ?>">Galeri</a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                ...
                                <li class="dropdown">
                                    ...
                                    <?php foreach($menu as $key => $value) :?>
                                        <li>
                                            <a class="dropdown-item" href="<?= site_url('halaman/'). $value->slug;?>"><?= $value->menu;?></a>
                                        </li>
